...
const ComingSoonPage: React.FC<ComingSoonPageProps> = ({
    ...
    console.log('ComingSoonPage rendered with pageTitle:', pageTitle);
                ...
                <div className="relative z-10 w-full text-center">
                    <div className="max-w-4xl mx-auto space-y-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto my-12">
                            <Link to="/portfolio" className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 cursor-pointer hover:bg-white/10 transition-all group">
                            ...
                            <Link to="/services" className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 cursor-pointer hover:bg-white/10 transition-all group">
                            ...
                            <Link to="/about" className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 cursor-pointer hover:bg-white/10 transition-all group">
                                <div className="text-2xl mb-2">👥</div>
                            ...
                            <Link to="/blog" className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 cursor-pointer hover:bg-white/10 transition-all group">
                                <div className="text-2xl mb-2">📝</div>
